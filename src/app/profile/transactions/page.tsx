    ...
    return (
      <main className="max-w-md mx-auto px-4 py-16">
        <div className="rounded-2xl border border-black/10 dark:border-white/15 bg-white/70 dark:bg-white/5 backdrop-blur-xl p-6">
          <h1 className="text-xl font-extrabold text-slate-900 dark:text-white mb-2">Transactions</h1>
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-10">
      <div className="mb-4 flex items-center gap-2">
        ...
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white">Historique des transactions</h1>
      </div>
            ...
            {txs.map((t) => (
              <li key={t.id} className="py-3 flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm text-slate-900 dark:text-white truncate">+ {euros(t.amountCents, t.currency)}</div>
