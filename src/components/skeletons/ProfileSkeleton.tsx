...
export default function ProfileSkeleton() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-10">
      ...
      <section className="rounded-2xl border border-black/10 dark:border-white/15 bg-white/60 dark:bg-white/5 backdrop-blur-xl p-6 shadow animate-pulse">
      ...
      <section className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="rounded-2xl border border-black/10 dark:border-white/15 bg-white/60 dark:bg-white/5 backdrop-blur-xl p-6 shadow animate-pulse">
